<?php
require('assets/php/session.class.php');
        ...
        <div id="container">
            ...
            <div id="container-right-side">
                <div id="profile-cart">
                        ...
                        <a href="assets/website/user/<?php if(!$_SESSION['idusuario']){
                            echo 'login-page.php';
                        } else {
                    ...
                    <a href="assets/website/user/cart.php" target="_blank">
                        <div id="cart-icon">
                ...
                <form action="assets/website/catalog/male.php" method="GET" id="form-search-bar">
                    <div id="search-bar">
